      ...
      <main className="flex w-full min-w-0 flex-col gap-4 p-4 pt-0">
        {readView === "pending" ? (
          ...
          <>
            ...
            >
              <div className="grid min-w-0 gap-6 lg:grid-cols-[220px_minmax(0,1fr)]">
                <TabsList className="flex h-auto w-full min-w-0 flex-col items-stretch justify-start self-start bg-transparent p-0 lg:sticky lg:top-4 max-lg:static max-lg:h-auto! max-lg:w-full max-lg:max-w-full max-lg:snap-x max-lg:rounded-none max-lg:[scrollbar-width:none] max-lg:flex-row max-lg:items-center max-lg:gap-1 max-lg:overflow-x-auto max-lg:overscroll-x-contain max-lg:px-1 max-lg:py-2 max-lg:[&::-webkit-scrollbar]:hidden">
